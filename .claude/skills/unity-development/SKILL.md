...
The Unity project is located at `src/Apps/KinemagicStudio-CE/` relative to the repository root.
Set `UNICLI_PROJECT` when running commands:

```bash
UNICLI_PROJECT=src/Apps/KinemagicStudio-CE unicli exec Compile --json
```
